...
<p>Для проверки работы всех триггеров были добавлены [тестовые данные](https://github.com/qa1etix/DB_20-PMI/blob/main/Лабораторная 4/Код/Триггеры/test.sql)</p>